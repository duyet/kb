...
- [templatebot verify skill](memory/projects/project-templatebot-verify-skill.md) — Project-local `.cursor/skills/verify-templatebot`; CDP CLI; Feature Map includes landing marquee + pay-to-install (unlock + email)
