...
- [AnyRouter playground MCP](memory/projects/project-anyrouter-playground-mcp.md) — Playground new chats enable AnyRouter MCP at the documented HTTP endpoint
