...
description: Project-local .cursor/skills/verify-templatebot drives the Vite marketplace over CDP; Feature Map includes pay-to-install and MCP publish
type: project
category: agents
...
created: 2026-09-02
updated: 2026-09-02
timestamp: 2026-09-02T09:06:00Z
---
...
- Feature map covers browse, preview (incl. `preview-scroll`), submit (incl. resubmit versions, Submit history, X post collect), leaderboard, dashboard, pay-to-install (Sale listings; local fixture `paid-demo.sql` / Night Counsel), and MCP publish (`features/mcp-publish.md`; Streamable HTTP `/mcp` + agent HTTP; Free-only over MCP).
