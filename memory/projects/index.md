...
- [duyet/monorepo](project-monorepo.md) — Public Bun+Turborepo for personal duyet.net web apps
- [duyetbot persona](project-duyetbot.md) — Autonomous agent persona that maintains public monorepo within clear scope
