---
name: cloudflare-acquires-astro
...
aliases: ["Astro joins Cloudflare", "Fred Schott Cloudflare"]
related: []
sources:
...
- On Cloudflare, each Flue agent maps to a Durable Object via the Flue / Agents SDK primitives.
