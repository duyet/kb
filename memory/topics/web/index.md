...
- [Flat design: hairline borders](tech-flat-design-hairline.md) — Prefer hairline borders over heavy shadows for public site UI
...
- [When Rust WASM is worth it](tech-rust-wasm-when.md) — WASM usually wins only when the TS path is >~1ms hot work
